                        ...
                        onChange={(val) => {
                            ...
                            <div className="mt-3 flex items-center space-x-3">
                                   {COLORS.map((color) => (
                                    ...
                                    className={({active, checked}) => cn("relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 active:ring-0 focus:ring-0 active:outline-none focus:outline-none boder-2 border-transparent", {
